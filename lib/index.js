...
var tests = [{ url: 'http://' + domain, to: toRoot, ok: null, actual: null }, { url: 'http://www.' + domain, to: toRoot, ok: null, actual: null }, { url: 'https://' + domain, to: toRoot, ok: null, actual: null }, { url: 'https://www.' + domain, to: toRoot, ok: null, actual: null }, { url: 'http://' + domain + path, to: toPath, ok: null, actual: null }, { url: 'http://www.' + domain + path, to: toPath, ok: null, actual: null }, { url: 'https://' + domain + path, to: toPath, ok: null, actual: null }, { url: 'https://www.' + domain + path, to: toPath, ok: null, actual: null }];
...
Promise.all(promises).then(function (results) {
  ...
  results.forEach(function (result) {
    ...
    var actual = result.ok ? '' : ' expected, but got ' + result.actual;
